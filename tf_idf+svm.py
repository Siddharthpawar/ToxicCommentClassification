...
_train = os.path.join(_ROOT, "train.csv")
if not os.path.isfile(_train):
    _alt = os.path.join(_ROOT, "train1.csv")
    _train = _alt if os.path.isfile(_alt) else _train
...
df = pd.read_csv(_train, low_memory=False)
